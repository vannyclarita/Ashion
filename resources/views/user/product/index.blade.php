                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="card">
                                        <div class="card-heading active">
                                            <a data-toggle="collapse" data-target="#collapseOne">Category List</a>
                                        </div>
                        ...
                        @foreach ( $products as $item )
                                @if ($item->image)
                                    ...
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="{{ asset('product-image/'.$item->image->image_name)}}">
                                            ...
                                            <ul class="product__hover">
                                                ...
                                                <li><a onclick="document.getElementById('transaksi{{$item->id}}').submit()"><span class="icon_bag_alt"></span></a></li>
                                            </ul>
                                        </div>
                                @else()
                                <div class="col-lg-4 col-md-6">
