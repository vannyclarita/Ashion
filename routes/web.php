...
//Route Review
Route::get('user/review/{id}' , [ReviewController::class, 'review']);
Route::post('user/addreview/{id}' , [ReviewController::class, 'addprocess']);
...
//Transaction Route
Route::get('admin/transaction', [TransactionController::class, 'indexAdmin'])->name('listTransaction');
Route::get('admin/transaction/edit/{id}', [TransactionController::class, 'editAdmin']);
Route::patch('admin/transaction/editprocess/{id}', [TransactionController::class, 'updateAdmin']);

//Response Route
Route::get('admin/review', [ProductController::class, 'review'])->name('listReview');
Route::get('admin/response/{id}', [ProductController::class, 'response']);
Route::post('admin/addresponse/{id}', [ProductController::class, 'responseAdd']);
