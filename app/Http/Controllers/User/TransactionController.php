...
class TransactionController extends Controller
{
    ...
    public function proof($id)
    {
        ...
        $transactions->detail = $transactions->details;

        return view('user.transaction.proof', compact('transactions'));
    }
    ...
    public function proofadd(Request $request, $id)
    {
        ...
        $user->notify(new Admin_notification ('Bukti Bayar Transaksi dengan id-'.$transaction->id.'Terkirim'));
    ...
    public function updateAdmin(Request $request, $id)
    {
        ...
        $user->notify(new User_notification('Transaksi dengan id-'.$transactions->id.$transactions->status));
